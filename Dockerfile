## Stage 1 : Add PGAudit to postgres:12.6 image
FROM postgres:12.6 AS postgresWithPgaudit
LABEL Alexander Kukushkin <alexander.kukushkin@zalando.de>


## Stage 2 : create the patroni image based on postgresWithPgaudit
FROM postgresWithPgaudit
